...
CONSTANTS
    PrunedLength        \* Number of blocks retained after pruning
...
(****************************************************************************)
(* Spendable UTXOs restricted to outputs within the prune window.           *)
(* Outputs at or below prune_height are unspendable regardless of maturity. *)
(****************************************************************************)
NotPrunedSpendableUTXOs == {u \in SpendableUTXOs : u.height > prune_height}
...
(****************************************************************************)
(* The non-pruned portion of the chain can be fully validated.              *)
(* Each block above prune_height is validated against the UTXO set          *)
(* built from only the non-pruned blocks preceding it.                      *)
(****************************************************************************)
PrunedChainValid ==
    \A block_idx \in (prune_height + 1)..ChainHeight:
