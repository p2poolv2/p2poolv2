...
- ShareChain.tla:
    ...
    The module also handles uncle shares when a new share is generate and later received and organised into the share chain.
...
Once you have downloaded the vscode extension you can then run the model checker or generate PDF of the specification from the integrated tool or from the command line as follow:
