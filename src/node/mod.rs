...
impl Node {
    ...
    pub fn handle_request_response_event(self: &mut Node, event: RequestResponseEvent<Message, Message>) -> Result<(), Box<dyn Error>> {
        ...
        match event {
            RequestResponseEvent::Message { peer, message: libp2p::request_response::Message::Request { request_id, request, channel } } => {
                ...
                if let Err(e) = self.handle_request(peer, request_id, request, channel) {
    ...
    fn handle_request(self: &mut Node, peer: libp2p::PeerId, request_id: libp2p::request_response::InboundRequestId, request: Message, channel: libp2p::request_response::ResponseChannel<Message>) -> Result<(), Box<dyn Error>> {
