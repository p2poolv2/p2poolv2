...
The `benchmark.sh` script automates the full comparison between default and native builds. It starts mock-bitcoind, builds each variant, runs jmeter, and prints a summary with latency percentiles.
