...
mod tests {
    ...
    #[tokio::test]
    async fn test_share_headers_rejects_num_zero() {
    ...
    #[tokio::test]
    async fn test_share_headers_rejects_num_above_max() {
        let node_handle = NodeHandle::new_for_test();
        let (state, _temp_dir) = build_test_state(node_handle).await;
    ...
    #[tokio::test]
    async fn test_share_headers_with_genesis() {
        let node_handle = NodeHandle::new_for_test();
        let (state, _temp_dir) = build_test_state(node_handle).await;
