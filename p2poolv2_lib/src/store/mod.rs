...
mod tests {
    ...
    fn test_get_btcaddresses_for_user_ids() {
        ...
        let subset_map: std::collections::HashMap<u64, String> = subset_results.into_iter().collect();
        ...
        let empty_results = store.get_btcaddresses_for_user_ids(&nonexistent_ids).unwrap();
